# -*- coding: utf-8 -*-
"""
Created on Sat Jun 19 23:47:50 2021
...
dataset_train = pd.read_csv('monthly_csv.csv')
...
# Creating a data structure with 38 timesteps and 1 output
X_train = []
y_train = []
for i in range(36, 828):
...
# Getting the real price of 2019
dataset_test = pd.read_csv('monthly_test.csv')
real_stock_price = dataset_test.iloc[:, 1:2].values

# Getting the predicted price of 2019
...
plt.plot(real_stock_price, color = 'red', label = 'Real Gold Price')
